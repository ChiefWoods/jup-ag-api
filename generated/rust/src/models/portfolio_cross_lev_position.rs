...
impl PortfolioCrossLevPosition {
    pub fn new(side: Side, entry_price: f64, mark_price: f64, size: f64, size_value: f64, pnl_value: f64, liquidation_price: f64, value: f64) -> PortfolioCrossLevPosition {
        PortfolioCrossLevPosition {
            address: None,
            name: None,
            image_uri: None,
            side,
